 ...
 */
public class PantallaOrdenarDomicilio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Una orden de: Tacos al pastor");

        jLabel3.setFont(new java.awt.Font("Segoe UI Symbol", 0, 14)); // NOI18N
        jLabel3.setText("Bebida: Agua de horchata");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaOrdenarDomicilio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaOrdenarDomicilio().setVisible(true);
            }
        });
    }
